...
parser.add_argument("-i", type=str, action='store',  dest='input', help="Input the FASTA/Q file") 
parser.add_argument("-g", type=str, action='store',  dest='gffinput', help="Input the GFF file")
parser.add_argument("-o", type=str, action='store',  dest='output', help="Name for the output files")
